...
\footercontent{%
  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      \vfill
        Master Thesis \\ University Bremen \hfill
    \end{column}
    \separatorcolumn%
    \begin{column}{\colwidth}
      \vfill
 ...
 % \end{block}
  ...
  \begin{block}{Reference}
    Read the full work here:\\
      %\href{https://github.com/paradx/mscthesis/releases/download/printed/thesis_singleSided.pdf}{https://github.com/paradx/mscthesis/releases/download/printed/thesis_singleSided.pdf}
       \vspace{1cm}
%    \nocite{*}
