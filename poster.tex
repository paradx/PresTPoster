% Unofficial University Bremen Poster template.
\documentclass[a0paper, dvipsnames]{beamer}
...
\usepackage{lmodern}
\usepackage[size=a0paper, orientation=portrait, width=122, height=91, scale=1.2]{beamerposter}
